...
extends AbstractObserver {
    ...
    protected void activate() {
        ...
        this.probe = new PropertyProbe("myturtles","myturtles","bug","score");
        this.addProbe(probe);
        super.activate();
        this.observe();
    }
    ...
    public void setupFrame(JFrame jFrame) {
        ChartPanel chartPanel = ChartsUtil.createChartPanel(this.dataset, "Score", null, null);
    ...
    protected void observe() {
        ...
        SwingUtilities.invokeLater(new Runnable(){
            ...
            public void run() {
                ...
                ScoreViewer.this.index++;
                if (ScoreViewer.this.timeFrame > 0 && ScoreViewer.this.index % ScoreViewer.this.timeFrame == 0) {
                    for (XYSeries xYSeries : ScoreViewer.this.series.values()) {
                        xYSeries.clear();
                    }
                }
            }
